...
const TCustomStyle = StyleSheet.create({
  mb0: {
    marginBottom: 0,
  },
  mb1: {
  ...
  itemListBox: {
    flex: 1,
    marginHorizontal: (-1 * SIZE.APP_BODY_PADDING) / 2,
    marginVertical: (-1 * SIZE.APP_BODY_PADDING) / 2,
  },
  itemBox: {
    flex: 1 / 2, //1
  ...
  itemTitleDateBox: {
    ...
    alignItems: 'flex-start',
    marginTop: SIZE.APP_BODY_PADDING / 8,
  ...
  itemDescBox: {
    width: '100%',
    marginTop: SIZE.APP_BODY_PADDING / 4,
  },
  itemDesc: {
    color: COLOR.FONT_LIGHT_GRAY,
    textAlign: 'left',
  ...
  searchItemListWrapper: {
    ...
    flexWrap: 'wrap',
    alignItems: 'flex-start',
    marginHorizontal: (-1 * SIZE.APP_BODY_PADDING) / 5,
    marginVertical: (-1 * SIZE.APP_BODY_PADDING) / 5,
  },
  searchItemWrapper: {
    width: '100%',
    paddingHorizontal: SIZE.APP_BODY_PADDING / 5,
    paddingVertical: SIZE.APP_BODY_PADDING / 5,
  },
  filterBtnBox: {
    width: '100%',
    flexDirection: 'row',
  ...
  //end item list page style

  //start item detail page style
  itemMainBox: {
    flex: 3,
    backgroundColor: COLOR.BG_GRAY,
    borderRightWidth: 1,
  ...
  itemSidebarBoxContent_new: {
    paddingHorizontal: 10,
    paddingVertical: 10,
    width,
  },
  //end item detail page style
});

export default TCustomStyle;
