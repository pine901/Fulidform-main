    ...
    <>
      {
        (item['empty_object']) ? (
          ...
          <View style={CustomStyle.itemBox}>
            <MyThumbnailBox item={item} itemType="recipe" onClickItem={() => vewItemDetail(item['id'])} />
...
export default React.memo(RecipeItem, arePropsEqual); //Export with memo of course :) 
