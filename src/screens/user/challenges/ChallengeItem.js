    ...
    <>
      {
        (item['empty_object']) ? (
          ...
          <View style={CustomStyle.itemBox}>
            <MyThumbnailBox item={item} itemType="challenge" onClickItem={() => vewItemDetail(item['id'])} />
...
export default React.memo(ChallengeItem, arePropsEqual); //Export with memo of course :) 
