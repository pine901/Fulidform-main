...
import { ROUTE_AUTH_STACK_NAVIGATOR, ROUTE_SIGNIN, ROUTE_WORKOUT_DETAIL } from '../../../routes/RouteNames';
import { apiGetWorkoutList, apiLoginRequired, apiResponseIsSuccess, API_PAGE_SIZE, } from '../../../utils/API';
import { signOut } from '../../../redux/auth/actions';
import { navReset } from '../../../utils/Nav';
import WorkoutSearchBox from './WorkoutSearchBox';
...
export default WorkoutListScreen = (props) => {
  ...
  const vewItemDetail = (itemId) => {
    navigation.navigate(ROUTE_WORKOUT_DETAIL, { itemId: itemId })
  }
      ...
      <View style={[CustomStyle.flexibleSplitter, CustomStyle.itemListPageWrapper]}>
        <View style={[CustomStyle.searchBoxWrapper]}>
          <View style={CommonStyles.body}>
            <Text fontSize="lg">FIND A WORKOUT</Text>
          </View>
          <WorkoutSearchBox
            {...props}
